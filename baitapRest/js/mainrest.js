...
getElement('tbKhoi1').innerHTML = sinhVienK1.tinhDiemTrungBinh(diemToan,diemLy,diemHoa).toFixed(2)
...
getElement('tbKhoi2').innerHTML = sinhVienK2.tinhDiemTrungBinh(diemVan,diemSu,diemDia,diemAnh).toFixed(2)
